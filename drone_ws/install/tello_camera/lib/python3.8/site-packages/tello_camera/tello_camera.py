...
def detect_circles(gray, dp=1.2, min_dist=50, param1=100, param2=50, min_radius=50, max_radius=600):
...
def color_fraction_in_circle(bgr_img, circle, color_ranges_hsv):
    ...
    cv2.circle(mask, (x, y), r, 255, thickness=5)
...
class TelloCamera(Node):
    def __init__(self):
        ...
        self.declare_parameter('activation_threshold', 0.2)
